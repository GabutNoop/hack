...
> **Fork ini (VPS / custom API):** WebUI resmi + Hermes Agent resmi. Ganti endpoint di **Settings → Providers** (Custom OpenAI-compatible). Mode tanpa sandbox: `HERMES_WEBUI_NO_SANDBOX=1`. Deploy VPS: `bash deploy.sh`. Panduan lengkap: [DEPLOY-ID.md](DEPLOY-ID.md).
